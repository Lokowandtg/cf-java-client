...
final public class CloudFoundryCleanerV2 implements Cleaner {
    ...
    public static Flux<Void> cleanBuildpacks(
    ...
    public static Flux<Void> cleanClients(UaaClient uaaClient, NameFactory nameFactory) {
    ...
    public static Flux<Void> cleanFeatureFlags(CloudFoundryClient cloudFoundryClient) {
    ...
    public static Flux<Void> cleanGroups(UaaClient uaaClient, NameFactory nameFactory) {
        return PaginationUtils.requestUaaResources(
                        startIndex ->
                                uaaClient
                                        .groups()
    ...
    public static Flux<Void> cleanIdentityProviders(UaaClient uaaClient, NameFactory nameFactory) {
        return uaaClient
                .identityProviders()
    ...
    public static Flux<Void> cleanIdentityZones(UaaClient uaaClient, NameFactory nameFactory) {
        return uaaClient
                .identityZones()
    ...
    public static Flux<Void> cleanNetworkingPolicies(
    ...
    public static Flux<Void> cleanOrganizationQuotaDefinitions(
            CloudFoundryClient cloudFoundryClient, NameFactory nameFactory) {
        return PaginationUtils.requestClientV2Resources(
                        page ->
                                cloudFoundryClient
    ...
    public static Flux<Void> cleanOrganizations(
            CloudFoundryClient cloudFoundryClient, NameFactory nameFactory) {
        return PaginationUtils.requestClientV2Resources(
                        page ->
                                cloudFoundryClient
    ...
    public static Flux<Void> cleanPrivateDomains(
            CloudFoundryClient cloudFoundryClient, NameFactory nameFactory) {
        return PaginationUtils.requestClientV2Resources(
                        page ->
                                cloudFoundryClient
    ...
    public static Flux<Void> cleanRoutes(
            CloudFoundryClient cloudFoundryClient, NameFactory nameFactory) {
    ...
    public static Flux<Void> cleanSecurityGroups(
            CloudFoundryClient cloudFoundryClient, NameFactory nameFactory) {
        return PaginationUtils.requestClientV2Resources(
                        page ->
                                cloudFoundryClient
    ...
    public static Flux<Void> cleanServiceBrokers(
            CloudFoundryClient cloudFoundryClient, NameFactory nameFactory) {
        return PaginationUtils.requestClientV2Resources(
                        page ->
                                cloudFoundryClient
...
//                                        cloudFoundryClient, serviceInstance, serverVersion))
    ...
    public static Flux<Void> cleanSharedDomains(
            CloudFoundryClient cloudFoundryClient, NameFactory nameFactory) {
        return PaginationUtils.requestClientV2Resources(
                        page ->
                                cloudFoundryClient
    ...
    public static Flux<Void> cleanSpaceQuotaDefinitions(
            CloudFoundryClient cloudFoundryClient, NameFactory nameFactory) {
        return PaginationUtils.requestClientV2Resources(
                        page ->
                                cloudFoundryClient
    ...
    public static Flux<Void> cleanSpaces(
            CloudFoundryClient cloudFoundryClient, NameFactory nameFactory) {
        return PaginationUtils.requestClientV2Resources(
                        page ->
                                cloudFoundryClient
...
//                .delayUntil( TODO: Georg: muss im v3 ausgeführt werden.
////                        space ->
////                                removeSpaceMetadata(
////                                        cloudFoundryClient,
////                                        space)
//                                ) // TODO: Remove once the delete spaces endpoint
    ...
    public static Flux<Void> cleanStacks(
            CloudFoundryClient cloudFoundryClient, NameFactory nameFactory) {
        return PaginationUtils.requestClientV2Resources(
                        page ->
                                cloudFoundryClient
    ...
    public static Flux<Void> cleanUserProvidedServiceInstances(
            CloudFoundryClient cloudFoundryClient, NameFactory nameFactory) {
        return PaginationUtils.requestClientV2Resources(
                        page ->
                                cloudFoundryClient
    ...
    public static Flux<Void> cleanUsers(
            CloudFoundryClient cloudFoundryClient, NameFactory nameFactory) {
        return PaginationUtils.requestClientV2Resources(
                        page ->
                                cloudFoundryClient
    ...
    public static Flux<Void> cleanUsers(UaaClient uaaClient, NameFactory nameFactory) {
        return PaginationUtils.requestUaaResources(
                        startIndex ->
                                uaaClient
                                        .users()
    ...
    public static boolean containsMember(Group group, Group candidate) {
        return group.getMembers().stream()
                .map(MemberSummary::getMemberId)
                .anyMatch(id -> candidate.getId().equals(id));
    }

    public static Mono<Map<String, String>> getAllDomains(CloudFoundryClient cloudFoundryClient) {
        return PaginationUtils.requestClientV2Resources(
                        page ->
                                cloudFoundryClient
                                        .privateDomains()
    ...
    public static Flux<Void> ifCfVersion(
