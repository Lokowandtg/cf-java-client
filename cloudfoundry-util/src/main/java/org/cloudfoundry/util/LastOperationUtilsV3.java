...
//import org.cloudfoundry.client.v3.serviceinstances.LastOperation;
import reactor.core.publisher.Mono;

/**
 * Utilities for {@link LastOperation}s
 */
public final class LastOperationUtilsV3 {

    private static final String IN_PROGRESS = "in progress";

    private LastOperationUtilsV3() {}
    ...
    public static Mono<Void> waitForCompletion(
        ...
        return lastOperationSupplier
                ...
                .onErrorResume(
                        t ->
                                t instanceof ClientV3Exception
                                        && ((ClientV3Exception) t).getStatusCode() == 404,
                        t -> Mono.empty())
                .then();
    }
}
